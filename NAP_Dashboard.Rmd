...
library(sf)
Africa_geom<-read_sf("C:/Workspace/RMardown_NAPS/Open-NAPs-Data/opennaps/Africa_Trace.shp")  
#need to reconfigure this path to your workspace

TmaxAfrica<-ee_extract(x=Tmax, y=Africa_geom, fun=ee$Reducer$mean())
...
prAfrica<-ee_extract(x=pr, y=Africa_geom, fun=ee$Reducer$mean())
