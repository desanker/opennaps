...
#df<-as.data.frame(temp, xy=TRUE)
#dygraph(df, main = "Wordclim Global Temperatures") %>%
 # dyRangeSelector(dateWindow = c("2020-01-01", "2100-12-01"))
```

```{r,echo=FALSE}
library(dygraphs)
dygraph(nhtemp, main = "New Haven Temperatures") %>% 
  dyRangeSelector(dateWindow = c("1920-01-01", "1980-12-01"))
```
